...
const team = [
  {
    name: "Dogs",
    role: "Dogs care tips and resources",
    imageUrl: "/images/dog2.jpg",
    location: "Toronto, Canada",
  },
  {
    name: "Cats",
    role: "Cats care tips and resources",
    imageUrl: "/images/cat2.jpg",
    location: "Glasgow, Scotland",
  },
  {
    name: "Birds",
    role: "Birds care tips and resources",
    imageUrl: "/images/bird1.jpg",
...
export default function Example() {
  ...
  return (
    <div className="bg-[#6699CC]/50">
      <main className="relative isolate">
        {/* Team section */}
        <div className="mx-auto max-w-7xl px-6 py-10 text-center lg:px-8">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-pretty text-4xl font-semibold tracking-tight text-[#003B6D]">
              Pet Care
            </h2>
          ...
          <ul
            role="list"
            className="mx-auto mt-20 grid max-w-5xl justify-items-center grid-cols-1 gap-x-8 gap-y-14 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
          >
            {team.map((person) => (
              <li key={person.name}>
                <img
                  alt=""
                  src={person.imageUrl}
                  className="aspect-[14/13] w-full rounded-2xl object-cover shadow-xl outline outline-1 -outline-offset-1 outline-white/10"
                />
                <h3 className="mt-6 text-lg/8 font-semibold tracking-tight text-[#003B6D]">
                  {person.name}
                </h3>
                <p className="text-md text-[#003B6D]">{person.role} </p>
              </li>
            ))}
          </ul>
        </div>
